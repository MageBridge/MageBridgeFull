...
if ($params->get('load_jquery', 1) == 1) $templateHelper->load('jquery');
if ($params->get('load_jquery_easing', 1) == 1) $templateHelper->load('jquery-easing');
if ($params->get('load_jquery_cycle', 1) == 1) $templateHelper->load('js', 'jquery/jquery.cycle.all.min.js');
