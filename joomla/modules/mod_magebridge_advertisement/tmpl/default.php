<?php
/**
 * Joomla! module MageBridge: Advertisement
 *
...
?>
<div class="magebridge-advertisement magebridge-module">
			...
			<?php if ($params->get('show_price', 1)) : ?>
				<?php if ($product['has_special_price'] && $params->get('special_price', 1) != 0): ?>
					...
					<?php if ($product['special_percentage'] > 0): ?>
						<p><?php echo round($product['special_percentage']); ?>
							% <?php echo JText::_('MOD_MAGEBRIDGE_PRODUCTS_DISCOUNT'); ?></p>
					<?php endif; ?>
			...
			<?php if ($params->get('show_readmore', 1) || $params->get('show_addtocart')) : ?>
				<ul>
					<?php if ($params->get('show_readmore', 1)) : ?>
						<li><a href="<?php echo $product['url']; ?>"
							   title="<?php echo $product['readmore_label']; ?>"><?php echo $product['readmore_text']; ?></a>
						</li>
					<?php endif; ?>
					<?php if ($params->get('show_addtocart', 1)) : ?>
						<li><a href="<?php echo $product['addtocart_url']; ?>"
							   title="<?php echo $product['addtocart_label']; ?>"><?php echo $product['addtocart_text']; ?></a>
						</li>
					<?php endif; ?>
				</ul>
			<?php endif; ?>
